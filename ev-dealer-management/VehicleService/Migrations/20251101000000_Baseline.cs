...
namespace VehicleService.Migrations
{
    ...
    ///
    /// SEED remains guarded raw SQL, which IS provider-neutral:
    /// INSERT INTO ... SELECT <values> WHERE NOT EXISTS (...) uses only
    /// double-quoted identifiers and SELECT-without-FROM, both valid SQLite
    /// and Postgres.
    ///
    /// SHADOW FK (review round 4): EF infers a Vehicle->VehicleTypes FK from
    /// the VehicleType.Vehicles navigation even though Vehicle has no
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // Shadow property: EF infers this FK from the
                    // VehicleType.Vehicles navigation (Vehicle has no
                    // VehicleTypeId property and no VehicleType navigation --
                    // the relationship is one-sided). It is part of the model
                    // regardless, and the pre-baseline EnsureCreated schema
                    // had this column, so omitting it left fresh databases
                    // short one column + index (caught in review round 4).
                ...
                constraints: table =>
                {
                    ...
                    // Matches the model's inferred relationship: ClientSetNull,
                    // NOT Restrict (an owner-less vehicle keeps its type id).
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Vehicles",
                column: "DealerId");
            // Shadow-FK index: EnsureCreated emits this and the model expects
            // it (review round 4).
            migrationBuilder.CreateIndex(
